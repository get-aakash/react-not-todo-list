            ...
            <form onSubmit={handleSubmit}>
                <div className='row mt-3 g-2'>
                    <div className='col-md-6'>
                        <input type="text" className="form-control" name="task" required
                            placeholder="Task" onChange={handleChange} />
                    </div>
                    <div className='col-md-3'>
                        <input type="number" min={1} name="hr" className="form-control" required placeholder="Hours" onChange={handleChange} onKeyDown={handleInvChar}/>
                    </div>
